...
export default function BenzIcon(props) {
  return (
    <SvgIcon {...props}>
      <switch>
        <g>
          ...
          >
            ...
            <stop
              offset=".1"
              style={{ stopColor: '#c1c5c4', stopOpacity: 1 }}
            />
            <stop
              offset=".3"
              style={{ stopColor: '#9ba1a2', stopOpacity: 1 }}
            />
            <stop
              offset=".5"
              style={{ stopColor: '#7d8487', stopOpacity: 1 }}
            />
            <stop
              offset=".7"
              style={{ stopColor: '#687074', stopOpacity: 0 }}
            />
            <stop
              offset=".8"
              style={{ stopColor: '#5b6469', stopOpacity: 0 }}
            />
            <stop offset="1" style={{ stopColor: '#576065', stopOpacity: 0 }} />
          </linearGradient>
          <path
            opacity=".4"
            fill="url(#c)"
          ...
          >
            ...
            <stop offset="1" style={{ stopColor: '#00111e', stopOpacity: 0 }} />
          </linearGradient>
          <path
            fill="url(#e)"
          ...
          >
            <stop
              offset=".1"
              style={{ stopColor: '#02131f', stopOpacity: 1 }}
            />
            <stop
              offset=".9"
              style={{ stopColor: '#02131f', stopOpacity: 0 }}
            />
          </linearGradient>
          <path
            fill="url(#f)"
          ...
          <linearGradient
            ...
            y2="40.4"
          >
            <stop offset="0" style={{ stopColor: '#02131f', stopOpacity: 1 }} />
            <stop
              offset=".1"
              style={{ stopColor: '#02131f', stopOpacity: 1 }}
            />
            <stop offset="1" style={{ stopColor: '#02131f', stopOpacity: 0 }} />
          </linearGradient>
          <path
            opacity=".8"
            fill="url(#h)"
          ...
          >
            ...
            <stop offset="1" style={{ stopColor: '#3b474e', stopOpacity: 0 }} />
          </linearGradient>
          <path
            fill="url(#j)"
            d="m32.5 31.3-.1.1s0 .2.2.1c.1-.1 3-1.6 4-2.2l-3.5-24c-.1-.9-.5-1.3-1.2-1.6l.4 27.8.2-.2z"
          ...
          <linearGradient
            ...
            y2="49"
          >
            <stop offset="0" style={{ stopColor: '#24303a', stopOpacity: 0 }} />
            <stop offset="0" style={{ stopColor: '#25323b', stopOpacity: 0 }} />
          ...
          >
            ...
            <stop offset="1" style={{ stopColor: '#a5abaf', stopOpacity: 0 }} />
          </linearGradient>
          <path
            fill="url(#l)"
          ...
          >
            ...
            <stop
              offset=".7"
              style={{ stopColor: '#2b373f', stopOpacity: 1 }}
            />
            <stop
              offset=".7"
              style={{ stopColor: '#36424a', stopOpacity: 1 }}
            />
            <stop
              offset=".7"
              style={{ stopColor: '#49545b', stopOpacity: 1 }}
            />
            <stop
              offset=".8"
              style={{ stopColor: '#646d73', stopOpacity: 0 }}
            />
            <stop
              offset=".8"
              style={{ stopColor: '#868d92', stopOpacity: 0 }}
            />
            <stop
              offset=".8"
              style={{ stopColor: '#b0b5b8', stopOpacity: 0 }}
            />
            <stop
              offset=".8"
              style={{ stopColor: '#e1e3e4', stopOpacity: 0 }}
            />
            <stop offset=".8" style={{ stopColor: '#fff', stopOpacity: 0 }} />
          </linearGradient>
          <path
            fill="url(#o)"
